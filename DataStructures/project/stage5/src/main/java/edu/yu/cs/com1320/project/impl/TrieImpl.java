...
public class TrieImpl<Value> implements Trie<Value> {
    ...
    public List<Value> getSorted(String key, Comparator<Value> comparator) {
        ...
        //Comparator<Value> comparator1 = new compare(key);
    ...
    public List<Value> getAllWithPrefixSorted(String prefix, Comparator<Value> comparator) {
        ...
        List<Value> resultList = new ArrayList<>(sortedMatches);
        //Comparator<Document> descendingComparator = (doc1, doc2) -> Integer.compare(doc2.wordCount(prefix), doc1.wordCount(prefix));
        resultList.sort(comparator/*.reversed()*/);
        return resultList;
    }
